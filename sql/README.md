...
**Важно**: Задача должна быть решена с учетом ранее изученного материала. Для предоставления данных реализуйте класс датахелпер. Используйте шаблон Page Objects для реализации логики взаимодействия с элементами страниц.        
